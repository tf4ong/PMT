...
class Dataset(object):
    ...
    def __init__(self,  model,classes, annot_path,size, batch, argu, tiny= False,dataset_type: str = "converted_coco"):
        self.tiny = tiny
        self.strides, self.anchors, NUM_CLASS, XYSCALE = utils.load_config(model,classes)
    ...
    def preprocess_true_boxes(self, bboxes):
        ...
        for bbox in bboxes:
            ...
            if bbox_class_ind >= self.num_classes:
                bbox_class_ind = self.num_classes-1
