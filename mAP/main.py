...
#ground_truth_files_list -> files with ground truth 
# 

for txt_file in ground_truth_files_list:
  #print(txt_file)
  file_id = txt_file.split(".txt",1)[0] # gives a number
...
for class_index, class_name in enumerate(gt_classes):
  ...
  for txt_file in predicted_files_list:
    ...
    file_id = txt_file.split(".txt",1)[0] # get file name 
    file_id = os.path.basename(os.path.normpath(file_id)) 
    if class_index == 0:
...
with open(results_files_path + "/results.txt", 'w') as results_file:
  ...
  for class_index, class_name in enumerate(gt_classes):
    ...
    predictions_data = json.load(open(predictions_file)) # the json file, loads dictionary of lists
